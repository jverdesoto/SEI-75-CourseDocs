...
// bigImg.id = 'bigImg'
// document.getElementById('card').appendChild(bigImg)
...
//title
const title = document.createElement('h1') // to create an HTML element 

title.innerHTML = data[i].title // to add data to said element (<h1>title</h1>)

document.getElementById('card' + i).appendChild(title) // place the newly created element into the id ('app')
...
document.getElementById('card' + i).appendChild(date)
...
document.getElementById('card' + i).appendChild(body)
...
document.getElementById('card' + i).appendChild(authorName)


//author avatar
const avatarImg = document.createElement('img')
 avatarImg.setAttribute('src', data[i].authorAvatar)
avatarImg.setAttribute('alt', data[i].title)
avatarImg.classList.add('avatarImg')
document.getElementById('card' +i).appendChild(avatarImg)


//cover image

const coverImg = document.createElement('img')
coverImg.setAttribute('src', data[i].cover)
coverImg.classList.add('coverImg')
document.getElementById('card' +i).appendChild(coverImg)
}}
loopData(data);
