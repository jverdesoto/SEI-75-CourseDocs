...
// function formatProducts(carousel, grid, sidebar) {
  ...
  let anonymous  = function (any){
    return any.map ((product) => {
    ...
    // let newArray = [anonymous(carouselProducts),anonymous(gridProducts),anonymous(sidebarProducts)]
   
    // return newArray
    
function formatProducts(carousel, grid, sidebar) {
  const returnArr = []
returnArr.push(anonymous(carousel),anonymous(grid),anonymous(sidebar))
return returnArr
}
