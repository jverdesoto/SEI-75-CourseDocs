...
document.getElementById('app').appendChild(title) // place the newly created element into the id ('app')
...
document.getElementById('app').appendChild(date)
...
authorImg.setAttribute('src', data[i].authorAvatar)
authorImg.setAttribute('alt', data[i].title)

document.getElementById('main').appendChild(authorImg)
...
document.getElementById('main').appendChild(coverImg)
	}}
