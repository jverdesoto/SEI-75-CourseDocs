const data = [
	...
	{
		category: "Eos culpa et voluptatem.",
		category: "unknown generator",
...
titlePost.classList.add('myClass')
document.getElementById('app').appendChild(title)
*/
//console.log(data[0].title);
const titlePost = document.createElement('h1')
//to put content between the <> </>
titlePost.innerHTML = data[0].cover
//to add a class
titlePost.classList.add('postZero')
//getting the id I want and appending the title to it
document.getElementById('app').appendChild(titlePost)
//other way to do it
//document.getElementById('app').innerHTML = `<h1>${data[0].title}</h1>`


//blog container to render the posts
