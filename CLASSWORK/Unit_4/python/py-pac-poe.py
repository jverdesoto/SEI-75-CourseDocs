...
def turn(board):
  ...
  while not valid:
    ...
    valid = validate_turn(board, cell)
    if not valid:
      print()
      print('------------------------------------------------')
      print('!! You can\'t go there you silly goose, try again')
      print('------------------------------------------------')
      print()
  
  # Update Board state and render
  ...
  # If game does not end, switch player
  else:
    board.switch_player()
...
def validate_turn(board, cell):
  return cell != None and board.board[cell] == 0
