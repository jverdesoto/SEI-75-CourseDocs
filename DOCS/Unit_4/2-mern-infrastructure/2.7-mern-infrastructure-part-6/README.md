...
### Create the **&LT;LoginForm>** Component
...
**The **&LT;SignUpForm>** is a good candidate, but we would probably want to refactor it into a function component.**

</p>

We've provided the `<LoginForm>` below, it's ready to use!
