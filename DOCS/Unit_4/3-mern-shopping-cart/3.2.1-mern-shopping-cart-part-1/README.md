...
You may be surprised not to find a `total` property, etc.
...
<code>git reset --hard origin/sync-cafe-7-shop-1-models</code>
...
No, because Mongoose could not have bound the document to <code>this</code>
...
<code>git reset --hard origin/sync-cafe-8-shop-1-virtuals</code>
...
<code>useEffect</code><br>hook with a <code>[]</code> dependency array.
...
> 👀 **"Upserting"** in database lingo means to insert (create) a record/document if it doesn't exist and update it when it does. 
...
<code>git reset --hard origin/sync-cafe-9-shop-1-finish</code>
